...
{
	_keybinds["MOVE_LEFT"] = sf::Keyboard::A;
	_keybinds["MOVE_RIGHT"] = sf::Keyboard::D;
	_keybinds["MOVE_UP"] = sf::Keyboard::W;
	_keybinds["MOVE_DOWN"] = sf::Keyboard::S;
	_keybinds["ATTACK"] = sf::Keyboard::Space;
}
